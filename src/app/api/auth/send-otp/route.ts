...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('OTP stored for email:', email.toLowerCase(), 'Code:', otp)

    // Send email using Resend with improved template
    const { data, error } = await resend.emails.send({
      from: `${FROM_NAME} <${FROM_EMAIL}>`,
      to: [email],
      subject: 'Verify Your Email - Complete Your Organization Registration',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          ...
          <title>Email Verification - Atom Connect</title>
        </head>
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: white;">
            ...
            <div style="padding: 40px 30px;">
              ...
              <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
                Hello ${organizationName || 'there'},
              </p>
              
              <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
                Thank you for starting your organization registration with Atom Connect. To complete your registration and verify your email address, please use the verification code below:
              </p>
              ...
              <div style="background: #fef3c7; border: 1px solid #f59e0b; border-radius: 8px; padding: 16px; margin: 24px 0;">
                <p style="color: #92400e; font-size: 14px; line-height: 1.5; margin: 0;">
                  <strong>Important:</strong> This verification code will expire in <strong>10 minutes</strong>. Please enter it on the registration page to complete your organization setup.
                </p>
              </div>
